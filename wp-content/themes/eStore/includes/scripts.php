<?php global $shortname; ?>
	...
	<script src="<?php bloginfo('template_directory');?>/js/DejaVu_Sans_Light_200.font.js" type="text/javascript"></script>
	...
	<![endif]-->
		<script type="text/javascript">		
		//<![CDATA[
			Cufon.replace('#featured span.tag',{textShadow:'1px 1px 0px rgba(0,0,0,0.4)'})
                        ('h3#deals-title')('#content span.tag',{textShadow:'1px 1px 0px #131212'})
                        ('h4.widgettitle',{textShadow:'1px 1px 0px #ffffff'})
                        ('ul#secondary-menu li a strong',{textShadow:'1px 1px 0px #1d1d1d'})
                        ('span.price-single',{textShadow: '1px 1px 1px rgba(0,0,0,0.4);'})
                        ('.addto-cart',{textShadow: '1px 1px 1px rgba(0,0,0,0.4);',fontSize: '16px'})
			...
			<?php }; ?>
                            Cufon.set('fontFamily', 'DejaVu Sans Light');
